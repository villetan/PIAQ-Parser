 ...
 *
 * @author ville
 * Luokka, joka tarjoaa toiminnallisuuden puuttuvan mittausdatan täyttämiseen.
 * Hienosti sanottuna, mittaus väli interpoloidaan lineaarisesti. Rumasti sanottuna hyppäyksen alku- ja loppupisteen välille
 * "piirretään" suora, ja halutut mittaukset katsotaan suoran perusteella. 
 * Tämä tapa altistaa mittausdatan virheille, mutta pienemmillä kuin 10s aikaväleillä tuskin vaikuttaa.
 */
public class HypynTayttaja {

    /**
     * Metodi, joka täyttää mittauksessa olevan hypyn lineaarisilla arvioilla. Esim. klo 13.15.22 on mittaus jonka jälkeen
     * on kahdeksan sekunnin tauko, jonka jälkeen mittaukset jatkuvat normaalisti 1s välein. Tällöin metodi palautta 7 puuttuvaa 
     * mittausta tuolta aikaväliltä.
     * 
     * @param hyppy Hyppy-olio, joka sisältää hypyn alku ja loppupisteen, sekä välin pituuden.
     * @param mittausValiMS läpikäytävän listan mittausten "normaali" aikaväli millisekunteina.
     * @return palauttaa listan mittauksista, jotka kuuluvat hypyn aikavälille. Mittausten arvot ovat lineaarisesti arvioituja.
     */
